...
ofPixelFormat getOfPixelFormatFromFourCCType(NDIlib_FourCC_video_type_e type)
{
	...
	switch(type) {
		case NDIlib_FourCC_video_type_RGBX:
		case NDIlib_FourCC_video_type_RGBA:
			//ofLogVerbose("getOfPixelFormatFromFourCCType") << "video format pixels RGBA";
			format = OF_PIXELS_RGBA;	
			break;
		case NDIlib_FourCC_video_type_BGRX:
		case NDIlib_FourCC_video_type_BGRA:	
			//ofLogVerbose("getOfPixelFormatFromFourCCType") << "video format pixels BGRA";
			format = OF_PIXELS_BGRA;	
			//format = OF_PIXELS_BGR;
			break;
		case NDIlib_FourCC_video_type_UYVY:
			//ofLogVerbose("getOfPixelFormatFromFourCCType") << "video format pixels UYVY";
			format = OF_PIXELS_UYVY;	
			break;
		default:
			ofLogWarning("ofxNDI : this pixel format is not supported");
			format = OF_PIXELS_RGBA;
